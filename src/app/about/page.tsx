...
export const metadata: Metadata = {
  title: 'About',
  description:
    'Nesciunt error porro sint saepe earum aliquid repellendus optio pariatur. Non quam odit sunt sapiente tenetur fugit. Ut ea ut quisquam quia quidem modi velit molestiae voluptatem.',
}
