...
const aboutHeader: string = "What gets me up in the morning.";
const aboutContentPara1: string = "With two decades of experience in the technology and security space, I've spanned the experiences of Board meetings, and troubleshooting outages at midnight.  Whether it is a boardroom, conference hall, or datacenter, I have a singular passion: building and leading teams to solve complex problems. I've been a CISO, architect, developer, and engineer.  I've been a consultant, speaker, mentor, and friend. ";
const aboutContentPara2: string = "After 16 years in the industry, I founded Bitfire Security as a small, boutique security firm that delivered exceptional results to hand-picked customers.  The practice grew... and grew.  Bitfire won a \"Top 10 Security Assessment Company,\" spot in the same year it won \"Top 10 Managed Services Providers.\"  Bitfire Security became too broad and risked losing its identity. Bitfire.ai offers services for conversational AI operations. Justikar spun off to offer managed IT and security services to small and midsize enterprises.";
